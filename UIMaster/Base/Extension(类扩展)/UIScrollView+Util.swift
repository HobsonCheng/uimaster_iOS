...
extension UIScrollView {
    ...
    public var isAtTop: Bool {
        return self.contentOffset.y == 0.0 ? true : false
    }
    ...
    public var canScrollToBottom: Bool {
       return self.contentSize.height > self.bounds.size.height ? true : false
    }
    ...
    public var verticalScroller: UIView {
        ...
        return objc_getAssociatedObject(self, #function) as? UIView ?? UIView()
    }
