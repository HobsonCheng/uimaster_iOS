...
public struct Contacts {
    ...
    public static func requestAccess(_ requestGranted: @escaping (Bool, Error?) -> Void) {
    ...
    public static func authorizationStatus(_ requestStatus: @escaping (CNAuthorizationStatus) -> Void) {
    ...
    public static func fetchContacts(completionHandler: @escaping (_ result: FetchResults) -> Void) {
    ...
    @available(iOS 10.0, *)
    public static func fetchContacts(ContactsSortorder sortOrder: CNContactSortOrder, completionHandler: @escaping (_ result: FetchResults) -> Void) {
        let contactStore = CNContactStore()
        var contacts: [CNContact] = [CNContact]()
        let fetchRequest = CNContactFetchRequest(keysToFetch: [CNContactVCardSerialization.descriptorForRequiredKeys()])
    ...
    /// - Parameter completionHandler: It will return Dictonary of Alphabets with Their Sorted Respective Contacts.
     @available(iOS 10.0, *)
     public static func fetchContactsGroupedByAlphabets(completionHandler: @escaping (GroupedByAlphabetsFetchResults) -> Void) {
        let contactStore = CNContactStore()
        let fetchRequest = CNContactFetchRequest(keysToFetch: [CNContactVCardSerialization.descriptorForRequiredKeys()])
    ...
    /// Fetching Contacts from phone
    /// - parameter completionHandler: Returns Either [CNContact] or Error.
    public static func fetchContactsOnBackgroundThread(completionHandler: @escaping (_ result: FetchResults) -> Void) {
    ...
    /// - parameter completionHandler: Returns Either [CNContact] or Error.
    public static func searchContact(searchString string: String, completionHandler: @escaping (_ result: FetchResults) -> Void) {
        let contactStore = CNContactStore()
        var contacts: [CNContact] = [CNContact]()
    ...
    /// - parameter completionHandler: Returns Either CNContact or Error.
    public static func getContactFromID(Identifires identifiers: [String], completionHandler: @escaping (_ result: FetchResults) -> Void) {
        let contactStore = CNContactStore()
        var contacts: [CNContact] = [CNContact]()
...
public struct Telephone {
    ...
    public static func isCapableToCall(completionHandler: @escaping (_ result: Bool) -> Void) {
    ...
    /// - parameter completionHandler: Returns Bool.
    public static func isCapableToSMS(completionHandler: @escaping (_ result: Bool) -> Void) {
