...
final class ItemWithPhoto: UICollectionViewCell {
    ...
    func updateAppearance(forPoint view: UIView) {
        view.frame.size = CGSize(width: unselectedCircle.width - unselectedCircle.bordersWidth * 2, height: unselectedCircle.height - unselectedCircle.bordersWidth * 2)
