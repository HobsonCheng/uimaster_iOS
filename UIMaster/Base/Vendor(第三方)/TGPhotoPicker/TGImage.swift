...
extension UIColor {
 ...
 func + (leftImage: UIImage, rigthImage: UIImage) -> UIImage {
    return leftImage.with { _ in
 ...
 func += (leftImage:inout UIImage, rigthImage: UIImage) {
    leftImage += rigthImage
}

 class TGImagePresenter {
     enum Size {
        case fixed(CGSize)
        case resizable
    }
    ...
    fileprivate static let defaultGradientTo = CGPoint(x: 0, y: 1)
    ...
    private var cacheKey: String {
     ...
     func color(gradient: [UIColor], locations: [CGFloat] = defaultGradientLocations, from startPoint: CGPoint = defaultGradientFrom, to endPoint: CGPoint = defaultGradientTo) -> Self {
     ...
     func border(gradient: [UIColor], locations: [CGFloat] = defaultGradientLocations, from startPoint: CGPoint = defaultGradientFrom, to endPoint: CGPoint = defaultGradientTo
        ) -> Self {
