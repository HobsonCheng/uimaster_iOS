//
//  ChatVoiceIndicatorView.swift
//  UIMaster
//
//  Created by hobson on 2019/2/11.
//  Copyright © 2019 one2much. All rights reserved.
//

import UIKit

class ChatVoiceIndicatorView: UIView {
...
extension ChatVoiceIndicatorView {
    //正在录音
    func recording() {
        self.isHidden = false
    ...
    func updateMetersValue(_ value: Float) {
        ...
        let array = [
            R.image.recordingSignal001()!,
            R.image.recordingSignal002()!,
            R.image.recordingSignal003()!,
            R.image.recordingSignal004()!,
            R.image.recordingSignal005()!,
            R.image.recordingSignal006()!,
            R.image.recordingSignal007()!,
            R.image.recordingSignal008()!
        ]
